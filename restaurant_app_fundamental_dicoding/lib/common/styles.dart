...
const Color primaryColor =  Color(0xffF6F6F6);
const Color secondaryColor =  Color(0xffDFDFDF);
const Color accentColor =  Color(0xff009AAD);
const Color whiteColor = Colors.white;
const Color lightColor =  Color(0xff5F5F5F);
const Color blueColor =  Color(0xff053354);
